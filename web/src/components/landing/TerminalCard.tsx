...
const AWS_LINES = [
  ...
  { prompt: '~/AI_Study_Platform', cmd: 'export DATABASE_CONNECTION_STRING=... JWT_SECRET=...', color: '#4ade80' },
  ...
  { prompt: null, cmd: '✓ Supabase PostgreSQL + pgvector · S3 documents/assets', color: '#818cf8' },
];
