...
const STEPS = [
  { step: '01', title: 'Add Your Content', desc: 'Documents in 240+ formats, any video or podcast link, web articles, audio — drop it in and we detect the rest.', icon: BookOpen, color: 'from-cyan-500 to-blue-600', glow: 'rgba(6,182,212,0.4)' },
  ...
  { step: '03', title: 'Master the Topic', desc: 'One-button smart sessions, timed mock exams, and spaced repetition that schedules every review for you.', icon: GraduationCap, color: 'from-emerald-400 to-teal-600', glow: 'rgba(52,211,153,0.4)' },
];
