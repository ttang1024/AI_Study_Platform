    ...
    <div className="h-full overflow-y-auto bg-[var(--bg-app)]">
      ...
      {detail && (
        <ArtifactDetailModal
          ...
          mmText={mmText}
          mmGenerating={mmGenerating}
          mmStreaming={mmStreaming}
          mmError={mmError}
          chatLoading={chatLoading}
          chatMessages={chatMessages}
          togglingGlossaryId={togglingGlossaryId}
          masteredIds={masteredIds}
          togglingProblemId={togglingProblemId}
          masteredProblemIds={masteredProblemIds}
          onClose={() => setDetail(null)}
          onSwitch={switchDetail}
          onToggleReveal={() => setRevealAnswers(prev => !prev)}
          onGenerateMindMap={handleGenerateMindMap}
          onChatStreamSend={handleChatStreamSend}
          onToggleMastered={handleToggleMastered}
          onToggleProblemMastered={handleToggleProblemMastered}
        />
      )}
    </div>
  );
