...
import { X, ChevronLeft, ChevronRight, CheckCircle2, XCircle, Trophy, Loader2, Sparkles } from 'lucide-react';
...
export const PendingItemGenerationModal: React.FC<PendingItemGenerationModalProps> = ({ modal, setModal, onClose }) => {
              ...
              {modal.kind === 'flashcards' ? (
                <>
                  ...
                  <div className="px-5 py-3 sm:px-7 border-t border-zinc-100 flex items-center justify-between shrink-0">
                    <button onClick={onClose} className="rounded-lg border border-zinc-200 px-4 py-1.5 text-xs font-semibold text-zinc-600 hover:bg-zinc-50 transition-all">
                      Done
                    </button>
                    <Link
                      to={modal.detailTo}
