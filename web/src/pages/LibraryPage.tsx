...
const TABS: PageTab<View>[] = [
  ...
  },
  {
    ...
    // The Add panel lays itself out against the viewport (a fixed course rail beside a scrolling
    // form), so it needs a height rather than growing with its content the way Browse does.
    panelClassName: 'h-[calc(100vh-15.25rem)] min-h-[520px]',
  },
];
