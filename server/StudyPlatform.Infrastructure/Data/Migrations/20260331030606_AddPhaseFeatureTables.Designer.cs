...
namespace StudyPlatform.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260331030606_AddPhaseFeatureTables")]
    partial class AddPhaseFeatureTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudyPlatform.Domain.Entities.FreeRecallSession", b =>
                {
                    b.Property<Guid>("FreeRecallSessionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("KeyConceptsCovered")
                        .HasColumnType("text");

                    b.Property<string>("KeyConceptsMissed")
                        .HasColumnType("text");

                    b.Property<string>("RecallText")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasKey("FreeRecallSessionId");

                    b.HasIndex("DocumentId");

                    b.HasIndex("UserId", "DocumentId");

                    b.ToTable("FreeRecallSessions");
                });
            ...
            modelBuilder.Entity("StudyPlatform.Domain.Entities.LearningPath", b =>
                {
            ...
            modelBuilder.Entity("StudyPlatform.Domain.Entities.LearningPathItem", b =>
                {
                    b.Property<Guid>("LearningPathItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("StudyPlatform.Domain.Entities.PeerAnswer", b =>
                {
                    b.Property<Guid>("PeerAnswerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("PeerQuestionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("PeerAnswerId");

                    b.HasIndex("PeerQuestionId");

                    b.HasIndex("UserId");

                    b.ToTable("PeerAnswers");
                });

            modelBuilder.Entity("StudyPlatform.Domain.Entities.PeerQuestion", b =>
                {
                    b.Property<Guid>("PeerQuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("PeerQuestionId");

                    b.HasIndex("UserId");

                    b.ToTable("PeerQuestions");
                });
            ...
            modelBuilder.Entity("StudyPlatform.Domain.Entities.StudyActivity", b =>
                {
                    b.Property<Guid>("StudyActivityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("DocumentsOpened")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("StudyPlatform.Domain.Entities.StudyGoal", b =>
                {
            ...
            modelBuilder.Entity("StudyPlatform.Domain.Entities.UserStreak", b =>
                {
            ...
            modelBuilder.Entity("StudyPlatform.Domain.Entities.YouTubeChapter", b =>
                {
                    b.Property<Guid>("YouTubeChapterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("YouTubeChapterId");

                    b.HasIndex("UserId");

                    b.HasIndex("YouTubeVideoId");

                    b.ToTable("YouTubeChapters");
                });
            ...
            modelBuilder.Entity("StudyPlatform.Domain.Entities.LearningPathItem", b =>
                {
                    b.HasOne("StudyPlatform.Domain.Entities.LearningPath", "LearningPath")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("StudyPlatform.Domain.Entities.PeerAnswer", b =>
                {
                    b.HasOne("StudyPlatform.Domain.Entities.PeerQuestion", "PeerQuestion")
                        .WithMany("Answers")
                        .HasForeignKey("PeerQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
