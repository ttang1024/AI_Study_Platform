...
/**
 * Adapts the RN axios instance (Bearer token from AsyncStorage/SecureStore via
 * tokenStore, AI headers, mobile refresh-token plumbing) to the platform-agnostic
 * HttpClient the shared services in @study/core are written against.
 */
