// Client-side quiz grading. The backend's correctAnswer may be a bare letter, a
// prefixed option ("A) …"), or full text depending on how the AI generated it,
// so exact-match comparison is not sufficient.
...
// Strips an "A) " / "b. " style prefix so UIs that render their own letter
// badges don't show it twice.
